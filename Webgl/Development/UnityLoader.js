...
Module.setStatus('Downloading (0.0/1)');function LoadJSCodeBlob(blob, onload)
{
...
(function() {
 var loadPackage = function(metadata) {
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 16984028;
      var PACKAGE_UUID = 'e7e33ce2-aad6-4f02-8382-fef8c7f1cd73';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 13434536, 0, 0).open('GET', '/data.unity3d');
    new DataRequest(13434536, 13434702, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(13434702, 15459710, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(15459710, 16956402, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(16956402, 16984028, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
